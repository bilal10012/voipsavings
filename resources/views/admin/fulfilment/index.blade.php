...
@section('content')
    <div class="content">
        <h2 class="content-heading">fulfilment <a href="{{route('admin.fulfilment.create')}}" class="btn btn-alt-primary pull-right"><i class="fa fa-plus-circle"></i> Add new fulfilment</a></h2>
        <div class="block">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                    @forelse($fulfilment as $key => $service)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                @endif
                                <a href="{{route('admin.fulfilment.feature', $service->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="{{($service->is_featured)? 'Unmark as Featured': 'Mark as Featured'}}">
                                ...
                                <a href="{{route('admin.fulfilment.edit', $service->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit Product">
                        ...
                        <form id="delete-{{$service->id}}" action="{{ route('admin.fulfilment.destroy',  $service->id) }}" style="display:none" method="POST">
                         {{ method_field('DELETE') }}
                         {{ csrf_field() }}
                    </form>
                    </tr>
