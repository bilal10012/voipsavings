...
@section('title', 'Updating Services - '.$services_detail->title)
@section('before-css')
...
@section('content')
    <div class="content">
        <h2 class="content-heading">Service #{{$services_detail->id}} ({{$services_detail->name}}) <a href="{{route('admin.service.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.service.update', $services_detail->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="title" placeholder="title" value="{{(old('title'))?old('title'):$services_detail->title}}">
                                    @if($errors->has('title'))
                    ...
                    <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full p-0">
                                        ...
                                        <textarea name="description" class="js-summernote"style="height:300px;" value="{{(old('description'))?old('description'):$services_detail->description}}">{{(old('description'))?old('description'):$services_detail->description}}</textarea>
                            ...
                            <div class="block-content block-content-full">
                                ...
                                <img src="{{asset($services_detail->primary_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        <input type="file" class="custom-file-input" accept="image/*" name="primaryImage" data-toggle="custom-file-input">
                                        <label class="custom-file-label">Change Service's Featured Image</label>
                                    </div>
                            ...
                            <!-- <div class="block block-rounded block-themed">
                              <div class="block-header bg-gd-primary">
                              <h3 class="block-title">Services Inner Image</h3>
                            </div>
                            <div class="block-content block-content-full">
                                <div class="row gutters-tiny items-push">
                                <img src="{{asset($services_detail->inner_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        <input type="file" class="custom-file-input" accept="image/*" name="inner_image" data-toggle="custom-file-input">
                                        <label class="custom-file-label">Change Service's Detail Image</label>
                                    </div>
                            ...
                            <div class="form-group row text-center">
                                ...
                                <div class="col-12">
                                    <label class="css-control css-control-success css-switch">
                                        <input type="checkbox" class="css-control-input" value="checked" name="is_active" {{($services_detail->is_active == 1)? 'checked': ''}}>
            ...
            @csrf
            <input type="hidden" name="services_id" value="{{ $services_detail->id }}">
        </form>
    </div>
@endsection
@section('js')
