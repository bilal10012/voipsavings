...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new pricing <a href="{{route('admin.pricing.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
            ...
            <div class="row gutters-tiny">
                <div class="col-md-10">
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                <label class="col-12">Package Name</label>
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="Gold" value="{{old('title')}}">
                                    @if($errors->has('title'))
                            ...
                            <div class="form-group row">
                                <label class="col-12">Price Per Month</label>
                                <div class="col-12">
                                    <input type="text" class="form-control" name="price" placeholder="39" value="{{old('price')}}">
                                    @if($errors->has('role'))
                                        <div class="text-danger ml-5 font-weight-bold">{{ $errors->first('role') }}</div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="block block-rounded block-themed">
                        <!-- <div class="block-header bg-gd-primary">
                            <h3 class="block-title">pricing Image</h3>
                        </div> -->
                        <!-- <div class="block-content block-content-full">
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose pricing's Display Image</label>
                                    </div>
