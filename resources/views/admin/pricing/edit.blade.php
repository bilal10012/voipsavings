...
@section('title', 'Updating Services - '.$pricing_detail->title)
@section('before-css')
...
@section('content')
    <div class="content">
        <h2 class="content-heading">Service #{{$pricing_detail->id}} ({{$pricing_detail->name}}) <a href="{{route('admin.pricing.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.pricing.update', $pricing_detail->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="title" placeholder="title" value="{{(old('title'))?old('title'):$pricing_detail->title}}">
                                    @if($errors->has('title'))
                    ...
                    <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full p-0">
                                        ...
                                        <textarea name="description" class="js-summernote"style="height:300px;" value="{{(old('description'))?old('description'):$pricing_detail->description}}">{{(old('description'))?old('description'):$pricing_detail->description}}</textarea>
                            ...
                            <div class="block-content block-content-full">
                                ...
                                <img src="{{asset($pricing_detail->primary_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
            ...
            @csrf
            <input type="hidden" name="services_id" value="{{ $pricing_detail->id }}">
        </form>
    </div>
@endsection
@section('js')
