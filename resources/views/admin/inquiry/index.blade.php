                    ...
                    @forelse($inquiries as $key => $inquiry)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{url('panel/inquiry', $inquiry->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="View Inquiry">
                            ...
                            <form id="delete-{{$inquiry->id}}" action="{{ url('panel/inquiry/delete',  $inquiry->id) }}" style="display:none" method="POST">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        </form>
                        </tr>
