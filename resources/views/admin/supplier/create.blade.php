...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Supplier <a href="{{route('admin.supplier.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <div class="block">
            <div class="block-content">
                <form method="POST" action="{{route('admin.supplier.store')}}" id="createPost" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <!-- <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="form-material floating m-20">
                                        <textarea required class="form-control" name="short_description" rows="8"></textarea>
                            ...
                            <!-- <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full">
                                        ...
                                        <textarea name="description" required class="js-summernote"></textarea>
                                    </div>
                                </div>
                            </div> -->
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="block col-md-12">
                                ...
                                <label class="custom-file-label" for="example-file-input-custom">Choose Supplier Image</label>
                            </div>
                    ...
                    @csrf
                    <input type="submit" id="publishFaq" class="btn btn-primary m-30" value="Add Supplier">
                </form>
            </div>
        </div>
    </div>
