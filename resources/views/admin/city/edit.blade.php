...
@section('content')
    <div class="content">
        <h2 class="content-heading">City #{{$cities_detail->id}} ({{$cities_detail->name}}) <a href="{{route('admin.city.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.city.update', $cities_detail->id)}}" enctype="multipart/form-data">
