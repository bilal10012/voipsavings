...
@section('content')
    <div class="content">
        <h2 class="content-heading">City <a href="{{route('admin.city.create')}}" class="btn btn-alt-primary pull-right"><i class="fa fa-plus-circle"></i> Add new City</a></h2>
        <div class="block">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{route('admin.city.edit', $citie->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit City">
                        ...
                        <form id="delete-{{$citie->id}}" action="{{ route('admin.city.destroy',  $citie->id) }}" style="display:none" method="POST">
                         {{ method_field('DELETE') }}
                         {{ csrf_field() }}
                    </form>
                    </tr>
