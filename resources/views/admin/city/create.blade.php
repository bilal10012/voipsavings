...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new City <a href="{{route('admin.city.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="City Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
