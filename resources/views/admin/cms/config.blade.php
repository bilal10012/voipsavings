                ...
                <div class="py-20">
                    <div class="py-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <form method="POST" action="{{route('admin.updateConfig')}}">
                                                ...
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="tel" class="form-control" name="contact" value="{{getConfig('contact')}}" required>
                                                    <label for="material-color-primary2">Contact Number</label>
                                                </div>
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="tel" class="form-control" name="toll" value="{{getConfig('toll')}}" required>
                                                    <label for="material-color-primary2">Toll Free</label>
                                                </div>
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="tel" class="form-control" name="olympia" value="{{getConfig('olympia')}}" required>
                                                    <label for="material-color-primary2">Olympia Number</label>
                                                </div>
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="tel" class="form-control" name="centralia" value="{{getConfig('centralia')}}" required>
                                                    <label for="material-color-primary2">Centralia Number</label>
                                                </div>
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="tel" class="form-control" name="yelm" value="{{getConfig('yelm')}}" required>
                       ...
                       <!-- <div class="form-material form-material-primary floating m-20">
                                                ...
                                                <div class="form-material form-material-primary floating m-20">
                                                    <input type="text" class="form-control" name="news_text" value="{{getConfig('news_text')}}" required>
                                                    <label for="material-color-primary2">Newsletter Text</label>
                                                </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="block">
                                                <div class="block-content block-content-full">
                                                    <form class="dropzone" id="logo" action="{{route('admin.updateLogo')}}">@csrf</form>
