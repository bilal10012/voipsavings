            ...
            <div class="block-content">
                <form method="POST" action="{{route('admin.content.update')}}" enctype="multipart/form-data">
                    @foreach($contents as $content)
                        <div class="row">
                            <div class="col-md-8">
                              @if($content->id != 9&&$content->id != 3&&$content->id != 137&&$content->id != 82 &&$content->id != 83 && $content->id != 130)
                                    ...
                                    @endif
                               @endif
                                    @if($content->id != 10&&$content->id != 4&&$content->id !=1&&$content->id !=7)
                                    @if(  $content->id == 104 || $content->id == 105 || $content->id == 106 || $content->id == 107)
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <div class="form-material form-material-primary floating m-20">
                                    ...
                                    @endif
                               @endif
                               @if($content->id != 10&&$content->id != 12&&$content->id != 11&&$content->id != 5&&$content->id != 9&&$content->id != 8&&$content->id != 7&&$content->id != 6&&$content->id != 4&&$content->id != 3&&$content->id != 1&&$content->id != 2)
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <label>Short Description</label>
                                                <textarea class="js-summernote" name="content[{{$content->id}}][short_description]" rows="8">{!!$content->short_description!!}</textarea>
                                              
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                    @if($content->id != 12&&$content->id != 11&&$content->id != 5&&$content->id != 9&&$content->id != 8&&$content->id != 6&&$content->id != 3&&$content->id != 2   )
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <div class="block-content block-content-full">
