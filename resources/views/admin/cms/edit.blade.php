...
@section('content')
    ...
    <div class="content">
        <h2 class="content-heading">Editing {{ $contents->first()->page }} - {{ $contents->first()->section }} Content <a
                href="{{ route('admin.content') }}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <div class="block">
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-material form-material-primary floating m-20">
                                                <input type="text" class="form-control"
                                                    id="title"name="content[{{ $content->id }}][title]"
                                                    value="{{ $content->title }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            <div class="form-material form-material-primary floating mt-20">
                                                <input type="text" class="form-control"
                                                    name="content[{{ $content->id }}][button_text]"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-material form-material-primary floating mt-20">
                                                <input type="text" class="js-colorpicker form-control"
                                                    name="content[{{ $content->id }}][button_color]" data-format="hex"
                            ...
                            <div class="col-md-4">
                                ...
                                @if ($content->secondary_image != null)
                                    <div class="block">
                                        <div class="block-content block-content-full">
                                            <div class="dropzone" id="secondaryImage{{ $content->id }}"
                                                style="background-color: #6e80db;"></div>
                                            <small>Click on the image to upload a new Image.</small>
                                        </div>
                                    </div>
                                ...
                                @if ($content->video != null)
                                    <div class="form-group row  mt-20">
                                        ...
                                        <video src="{{ asset($content->video) }}" autoplay class="img-fluid"
                                            controls></video>
