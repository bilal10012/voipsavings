...
@section('content')
    <div class="content">
        <h2 class="content-heading">Services <a href="{{route('admin.service.create')}}" class="btn btn-alt-primary pull-right"><i class="fa fa-plus-circle"></i> Add new Services</a></h2>
        <div class="block">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                @endif
                                <a href="{{route('admin.service.feature', $service->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="{{($service->is_featured)? 'Unmark as Featured': 'Mark as Featured'}}">
                                ...
                                <a href="{{route('admin.service.edit', $service->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit Product">
                        ...
                        <form id="delete-{{$service->id}}" action="{{ route('admin.service.destroy',  $service->id) }}" style="display:none" method="POST">
                         {{ method_field('DELETE') }}
                         {{ csrf_field() }}
                    </form>
                    </tr>
