                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="Service Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Service's Display Image</label>
                                    </div>
