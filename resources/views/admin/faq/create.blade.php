...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new faq <a href="{{route('admin.faq.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="question" placeholder="faq Question" value="{{old('question')}}">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="answer" placeholder="faq Answer" value="{{old('answer')}}">
