...
@section('content')
    <div class="content">
        <h2 class="content-heading">Detail <a href="{{route('admin.detail.create')}}" class="btn btn-alt-primary pull-right"><i class="fa fa-plus-circle"></i> Add Details</a></h2>
        <div class="block">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{route('admin.detail.edit', $citie->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit City">
                        ...
                        <form id="delete-{{$citie->id}}" action="{{ route('admin.detail.destroy',  $citie->id) }}" style="display:none" method="POST">
                         {{ method_field('DELETE') }}
                         {{ csrf_field() }}
                    </form>
                    </tr>
