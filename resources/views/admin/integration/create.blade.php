...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new integration <a href="{{route('admin.integration.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.integration.store')}}" enctype="multipart/form-data">
            <div class="row gutters-tiny">
                <div class="col-md-10">
                    <div class="block block-rounded block-themed">
                        <div class="block-header bg-gd-primary">
                            <h3 class="block-title">integration Information</h3>
                        </div>
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="integration Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
