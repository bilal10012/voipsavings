...
@section('content')
    <div class="content">
        <h2 class="content-heading">Vehicle Inquiries</h2>
        <div class="block">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a href="{{url('panel/free-estimate-inquiry', $inquiry->id)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="View free estimate Inquiry">
                                        <i class="fa fa-eye text-primary"></i>
                                    </a>
                               

                                    <a href="javascript:;" onclick="if(confirm('Are you sure about deleting this free estimate Inquiry?') == true) document.getElementById('delete-'+{{$inquiry->id}}).submit();" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Delete Inquiry">
                            ...
                            <form id="delete-{{$inquiry->id}}" action="{{ url('panel/free-estimate-inquiry/delete',  $inquiry->id) }}" style="display:none" method="POST">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        </form>
