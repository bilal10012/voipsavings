...
@section('content')
    <div class="content">
        ...
        <div class="block">
            <div class="row">
                <div class="col-md-8 ">
                    <form method="POST" class="p-20" action="{{ route('admin.banners.update', $banner->id) }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 text-center">
                                ...
                                <div class="block col-md-12">
                                    ...
                                    <label class="custom-file-label" for="example-file-input-custom">Background
                                        Image</label>
                                </div>
                                @if ($errors->has('image'))
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-center">
                                    ...
                                    @if ($errors->has('image_2'))
                                        <div class="text-danger ml-5 font-weight-bold">{{ $errors->first('image_2') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
