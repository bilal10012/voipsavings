...
@section('content')
    <div class="content">
        <h2 class="content-heading">Our Work Management <a href="{{route('admin.our-work.create')}}" class="btn btn-alt-primary pull-right">Add New Image</a></h2>
            ...
            <div class="options-container fx-item-zoom-in fx-overlay-slide-down">
                ...
                <div class="options-overlay bg-black-op-75">
                    <div class="options-overlay-content">
                        <a class="btn btn-sm btn-rounded btn-noborder btn-alt-success min-width-65" href="{{route('admin.our-work.edit', $image->id)}}" data-toggle="tooltip" title="Edit Image"><i class="fa fa-pencil"></i> </a>
        ...
        <form id="delete-{{$image->id}}" action="{{ route('admin.our-work.destroy',  $image->id) }}" style="display:none" method="POST">
            {{ method_field('DELETE') }}
            {{ csrf_field() }}
        </form>
        @endforeach
