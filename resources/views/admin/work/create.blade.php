...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Image To the Work <a href="{{route('admin.our-work.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <div class="block">
            <div class="block-content">
                <form method="POST" action="{{route('admin.our-work.store')}}" id="createPost" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
