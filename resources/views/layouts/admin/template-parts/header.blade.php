        ...
        <div class="dropdown-menu dropdown-menu-right min-width-200" style="text-align:center; font-size:smaller;overflow-y:scroll; max-height: 200px;" aria-labelledby="page-header-user-dropdown">
                    ...
                    @forelse($notifications as $notification)
                        ...
                        <div  class="dropdown-item">
                            ...
                            <a href="#" class="mark-as-read" data-id="{{ $notification->id }}" data-type="{{ $notification->data['type']}}">User Name: {{ $notification->data['name'] }} filled {{ $notification->data['type'] }} Form  <br>     [{{ $notification->created_at }}]
