                    ...
                    <div class="card-body">
                        ...
                        <ul id="stepProgressBar">
                            ...
                            <li class="step {{ ($order->order_status == 1) ? 'active' : '' }}">
                                <p class="step-text active">Dispatched</p>
                                <div class="bullet"></div>
                            </li>
                            <hr width="100%" size="500">
                            <li class="step {{ ($order->order_status == 2) ? 'active' : '' }}">
                                <p class="step-text active">Delivered</p>
                                <div class="bullet"></div>
                            </li>
                            <hr width="100%" size="500">
                            <li class="step {{ ($order->order_status == 3) ? 'active' : '' }}">
                                <p class="step-text active">Ariving ({{$order->ariving_time }})</p>
                                <div class="bullet"></div>
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                ...
                                <label for="firstname"><b>Address :</b></label>
                                <span id="firstname">{{ $order->shipping_address1 }}, {{ $order->shipping_address2 }}</span><br>

                                <label for="lastname"><b>Country :</b></label>
                                <span id="lastname">{{ $order->shipping_country }}</span><br>

                                <label for="lastname"><b>State :</b></label>
                                <span id="lastname">{{ $order->shipping_state }}</span><br>

                                <label for="lastname"><b>Zip Code :</b></label>
                                <span id="lastname">{{ $order->shipping_zipcode }}</span><br>
                            </div> -->
                        </div>
                        <div class="row">
